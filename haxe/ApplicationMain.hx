...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("StorageRoomShootout", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("StorageRoomShootout", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "StorageRoomShootout";
		app.meta["name"] = "StorageRoomShootout";
